...
import { Forklift, ArrowLeft, Printer, QrCode } from "lucide-react";
      ...
      <div ref={certificateRef} className="bg-white p-8 border rounded-lg shadow-sm print:shadow-none print:border-none">
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-md">
            ...
            <p className="text-gray-600">
              {record.company?.phone_number && `Tel: ${record.company.phone_number}`}
            </p>
            <p className="text-gray-600">{record.company?.email}</p>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t">
          ...
          <div className="mt-6 text-center text-gray-500 text-sm">
            ...
            <p>To verify this certificate, scan the QR code or visit our website and enter the certificate number.</p>
          </div>
        </div>
      </div>
    </div>
